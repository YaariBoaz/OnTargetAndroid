...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorIosAppTracking/CapacitorIosAppTracking.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorScreenshot/CapacitorScreenshot.framework"
